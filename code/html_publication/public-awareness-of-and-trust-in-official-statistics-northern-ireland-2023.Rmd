---
title: "Public Awareness Of And Trust In Official Statistics, Northern Ireland 2023"
lang: "en"
output:
...
-   Public awareness of NISRA was moderate in `r current_year` with almost half of respondents (`r heard_of_nisra`%) indicating that they had heard of the Agency before being contacted about the survey. This is similar to 2022, when 49% of respondents had heard of NISRA.
...
Awareness is similar to 2022, when 49% of respondents had heard of NISRA, but lower than in 2020 and 2021 (during the COVID-19 pandemic), when 58% and 55% of respondents respectively had heard of NISRA.

Although awareness of NISRA has decreased since 2020 and 2021, awareness is still notably higher than in 2019 and previous years, prior to the COVID-19 pandemic (Chart 1).
...
Public awareness of NISRA remains lower than awareness of ONS, with three quarters (`r aware_of_ons`%) of respondents in 2023 reporting having heard of ONS. The difference between public awareness levels for NISRA and ONS has narrowed since 2018, which was prior to the start of the COVID-19 pandemic (Chart 2).
...
Awareness was highest for the Northern Ireland Census (`r heard_aware_census`%), followed by statistics on the number of people who live in Northern Ireland (`r heard_aware_people`%), the number of deaths (`r heard_aware_deaths`%) and the unemployment rate (60%). Statistics on  the percentage of journeys made by walking, cycling or public transport (`r heard_of_aware_cycling`%) were the least recognised as being produced by NISRA.
...
There is no significant difference in the level of trust in NISRA between 2023 and 2022 (Chart 5).When only respondents who expressed an opinion are considered, i.e. excluding 'don't knows', trust in NISRA is slightly lower than in 2021, and similar to the levels of trust in 2019 and 2016. Trust in NISRA in 2023 is significantly higher than in 2014.
...
Trust in NISRA is significantly higher than trust in the media, elected bodies and the Civil Service (Chart 7).

Across all institutions, trust is lowest for the media (`r trust_in_media`%) and elected bodies (`r trust_in_assem_elect_body`%), while `r trust_in_nics`% of respondents said they trust the Civil Service.
...
There was no significant difference in trust in NISRA statistics between 2023 and 2022. However, for those respondents who expressed an opinion, trust in NISRA statistics was significantly higher in 2023 compared to 2019 and earlier years.
...
The level of trust in NISRA statistics (`r trust_in_nisra_stats`%) is higher than the level of trust in ONS statistics (`r trust_in_ons_stats`%). While more respondents answered ‘don’t know’ with regard to NISRA statistics (`r dont_know_trust_nisra_stats`%) than for ONS statistics (`r dont_know_trust_ons_stats`%), the level of distrust in NISRA statistics (4%) is notably lower than the level of distrust in ONS statistics (14%) (Chart 9).
...
Amongst respondents who had a view, the proportion agreeing that NISRA statistics are important to understand Northern Ireland is similar to 2022.
...
The percentage of respondents who agree that the statistics produced are important to understand their country is higher for NISRA (`r importance_of_stats`%) than for ONS (`r importance_of_ons`%). 
...
Four-fifths (`r free_from_interference`%) of respondents agree that statistics produced by NISRA are free from political interference. Less than 1 in 10 (`r disagree_interference`%) of respondents disagree that NISRA statistics are free from political interference whilst the remaining respondents (`r dont_know_interference`%) answered that they ‘don’t know’ (Chart 12).

### Comparison over time

When all respondents are considered, the level of agreement that NISRA statistics are free from political interference is similar to 2022. However, when only those who expressed an opinion are considered, agreement has fallen since 2022.

The percentage of respondents disagreeing that NISRA statistics are free from political interference has increased slightly since 2022 but remains significantly lower than 2014 and 2016. 
...
Eighty-five percent of respondents (`r agree_confidential`%) agree that personal information provided to NISRA will be kept confidential while 7% disagree. The remaining respondents 'don’t know' (`r dont_know_confidential`%) (Chart 14).

### Comparison over time

The level of agreement that personal information provided to NISRA will be kept confidential has dropped since 2022. When only those respondents who expressed an opinion are considered, the level of agreement is significantly lower than in 2019 to 2022 but similar to 2016 and 2014.

The percentage of respondents in 2023 who disagreed with the statement is higher than in the previous four years (2019 to 2022) but similar to the level seen in 2014 and 2016.
...
In comparison, `r agree_confidential_ons`% of ONS respondents in `r ons_year` agree that personal information provided to ONS will be kept confidential. This is significantly higher than for NISRA (Chart 15).
